...
public class ElasticSearchConsumerWithManualCommit {
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic) {
        ...
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "10"); // max poll size for consumer.poll
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(ElasticSearchConsumerWithManualCommit.class.getName());
